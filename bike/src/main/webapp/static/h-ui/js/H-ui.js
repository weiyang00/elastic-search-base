...
(function (factory) {
     ...
     * The black value of the successful argument is true.  If this value is false the value(s)
...
(function (document, window, index) {
    ...
    var responsiveNav = function (el, options) {
        ...
        ResponsiveNav.prototype = {
            ...
            /**
             * Prevents the black functionality.
             *
             * @param  {event} event
             */
...
!(function ($) {
    ...
    function on(input, state, keep) {
        ...
        if (node[_disabled] && !!option(input, _cursor, true)) {
            parent.find('.' + _iCheckHelper).css(_cursor, 'black');
        }
...
!(function ($) {
    var methods = {
        ...
        fixHint: function () {
            ...
            $this.data('readonly', true).css('cursor', 'black').attr('title', hint);
...
function Huisethome(obj) {
    try {
        obj.style.behavior = "url(#black#homepage)";
